...
//        demo.Util.addButton(toolbar, 'Pan', 'pan', function () { network.setPanInteractions(); });
    ...
    createTreeToolbar: function (tree) {
        var toolbar = document.createElement('div');
        demo.Util.addButton(toolbar, 'Reset Order', '/static/images/twaver/reset.png', function () { tree.setSortFunction(null); });
        demo.Util.addButton(toolbar, 'Ascend Order', '/static/images/twaver/ascend.png', function () {
        ...
        demo.Util.addButton(toolbar, 'Descend Order', '/static/images/twaver/descend.png', function () {
            tree.setSortFunction(function (d1, d2) {
                if (d1.getName() < d2.getName()) {
                    return 1;
                } else if (d1.getName() == d2.getName()) {
        ...
        demo.Util.addButton(toolbar, 'Move Selection To Top', '/static/images/twaver/top.png', function () { tree.getDataBox().moveSelectionToTop(); });
        demo.Util.addButton(toolbar, 'Move Selection Up', '/static/images/twaver/up.png', function () { tree.getDataBox().moveSelectionUp(); });
        demo.Util.addButton(toolbar, 'Move Selection Down', '/static/images/twaver/down.png', function () { tree.getDataBox().moveSelectionDown(); });
        demo.Util.addButton(toolbar, 'Move Selection To Bottom', '/static/images/twaver/bottom.png', function () { tree.getDataBox().moveSelectionToBottom(); });
        demo.Util.addButton(toolbar, 'Expand', '/static/images/twaver/expand.png', function () {
        ...
        demo.Util.addButton(toolbar, 'Collapse', '/static/images/twaver/collapse.png', function () {
            if (tree.getSelectionModel().size() == 1) {
    ...
    addButton: function (div, name, src, callback) {
        ...
        if (src) {
            ...
            if (src.indexOf('/') < 0) {
                src = '/static/images/twaver/' + src + '.png';
            }
