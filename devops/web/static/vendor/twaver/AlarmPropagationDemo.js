...
//        network.adjustBounds({ x: 0, y: 0, width: 1200, height: 800 });
    ...
    registImages: function () {
        this.registerImage("/static/images/twaver/portDownImage.png");
        this.registerImage("/static/images/twaver/portUpImage.png");
        this.registerImage("/static/images/twaver/rackImage.png");
        this.registerImage("/static/images/twaver/server1.png");
        this.registerImage("/static/images/twaver/server2.png");
        this.registerImage("/static/images/twaver/server3.png");
        this.registerImage("/static/images/twaver/server4.png");
        this.registerImage("/static/images/twaver/rack_icon.png");

        this.registerImage("/static/images/twaver/att1.png");
        this.registerImage("/static/images/twaver/att2.png");
        this.registerImage("/static/images/twaver/att3.png");
        this.registerImage("/static/images/twaver/att4.png");
        this.registerImage("/static/images/twaver/att5.png");
        this.registerImage("/static/images/twaver/att6.png");
        this.registerImage("/static/images/twaver/att7.png");
        this.registerImage("/static/images/twaver/att8.png");
    },
